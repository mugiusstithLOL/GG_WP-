...
class Player(GameSprite):
 ...
 def fire(self):
     bullet = Bullet('pl.png', self.rect.right, self.rect.centery, 15, 20, 15)
     bullets.add(bullet)
...
w1 = GameSprite('vvvv.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('vvvv.png', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('mr.jpg', 5, win_height - 80, 80, 80, 0, 0)
